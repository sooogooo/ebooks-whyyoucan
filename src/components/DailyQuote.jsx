...
const styles = {
  ...
  card: {
    ...
    background: 'linear-gradient(135deg, #fbf2e6 0%, #f4dfd6 60%, #ead9bf 100%)',
    borderRadius: 'var(--border-radius-lg)',
    boxShadow: '0 12px 32px rgba(91, 65, 40, 0.12)',
    cursor: 'pointer',
  ...
  cardFlipped: {
    background: 'linear-gradient(135deg, #eaf1e8 0%, #d8e5db 100%)',
  },
  quoteText: {
    fontSize: '1.4rem',
    lineHeight: 1.8,
